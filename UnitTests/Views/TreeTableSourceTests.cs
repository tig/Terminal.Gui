...
│└+Route 66    │Great race course      │";
		...
		tv.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight));
...
";
		...
		tv.ProcessKeyPressed (new (ConsoleDriverKey.CursorLeft));
...
";
		...
		Application.Top.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight));
...
";
		...
		tv.ProcessKeyPressed (new KeyEventArgs (ConsoleDriverKey.CursorDown));
		tv.ProcessKeyPressed (new KeyEventArgs (ConsoleDriverKey.Space));
		tv.Draw ();

...
11111│22222
     │     ";
			...
			tileView.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight, KeyBindingScope.HotKey));
...
└────┴────┘";
		...
		{
			var tileView = Get11By3TileView (out var line);
			tileView.ProcessKeyPressed (new (tileView.ToggleResizable));
...
11111◊22222
     │     ";
			...
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight));
			tileView.Draw ();
...
111111◊2222
      │     ";
			...
			// and 2 to the left
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorLeft));
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorLeft));
			tileView.Draw ();
...
22222222222";
			...
			// Keyboard movement on splitter should have no effect if it is not focused
			var handled = tileView.ProcessKeyPressed (new (ConsoleDriverKey.CursorDown, KeyBindingScope.HotKey));
...
22222222222";
			...
			tileView.ProcessKeyPressed (new (ConsoleDriverKey.CursorDown));
...
─────◊─────";
			...
			// And 2 up
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorUp));
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorUp));
			tileView.SetNeedsDisplay ();
			tileView.Draw ();
			looksLike =
...
22222222222";
			...
			line.ProcessKeyPressed (new (ConsoleDriverKey.CursorDown));
			tileView.Draw ();
			looksLike =
	    @"    
11111111111

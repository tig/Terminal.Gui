...
namespace Terminal.Gui.ViewsTests {
	...
	public class TextValidateField_NET_Provider_Tests {
		...
		public void Initialized_With_Cursor_On_First_Editable_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.D1));
		...
		public void Input_Ilegal_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.A));
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight));
			field.ProcessKeyPressed (new (ConsoleDriverKey.CursorRight));
			field.ProcessKeyPressed (new (ConsoleDriverKey.Home));
		...
		public void End_Key_Last_Editable_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.End));
		...
		public void Left_Key_Stops_In_First_Editable_Character ()
		{
			...
			for (int i = 0; i < 10; i++) {
				field.ProcessKeyPressed (new (ConsoleDriverKey.CursorLeft));
			}
			field.ProcessKeyPressed (new (ConsoleDriverKey.D1));
		...
		public void When_Valid_Is_Valid_True ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.D2));
			Assert.Equal ("--(12  )--", field.Text);
			Assert.False (field.IsValid);

			field.ProcessKeyPressed (new (ConsoleDriverKey.D3));
			Assert.Equal ("--(123 )--", field.Text);
			Assert.False (field.IsValid);

			field.ProcessKeyPressed (new (ConsoleDriverKey.D4));
		...
		public void Delete_Key_Doesnt_Move_Cursor ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.Delete));
			field.ProcessKeyPressed (new (ConsoleDriverKey.Delete));
			field.ProcessKeyPressed (new (ConsoleDriverKey.Delete));
		...
		public void Backspace_Key_Deletes_Previous_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.Backspace));
	...
	public class TextValidateField_Regex_Provider_Tests {
		...
		public void Home_Key_First_Editable_Character ()
		{
			...
			field.ProcessKeyPressed (new (ConsoleDriverKey.D1));
			field.ProcessKeyPressed (new (ConsoleDriverKey.D0));
			field.ProcessKeyPressed (new (ConsoleDriverKey.D0));
			field.ProcessKeyPressed (new (ConsoleDriverKey.D0));
		...
		public void End_Key_End_Of_Input ()
		{
			...
			// Insert 9
			field.ProcessKeyPressed (new (ConsoleDriverKey.D9));

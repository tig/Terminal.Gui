...
╚══└───────────────┘", output);
		...
		public void Dialog_Opened_From_Another_Dialog ()
		{
			...
			Application.Iteration += (s, a) => {
				iterations++;
				if (iterations == 0) {
					Assert.True (btn1.ProcessKeyPressed (new (ConsoleDriverKey.Space)));
      ...
      └──────────────────────────────────────────────────────────────────┘";
					...
					Assert.True (btn2.ProcessKeyPressed (new (ConsoleDriverKey.Space)));
      ...
      └──────────────────────────────────────────────────────────────────┘", output);
					...
					Assert.True (Application.Current.ProcessKeyPressed (new (ConsoleDriverKey.Enter)));
				} else if (iterations == 3) {
					TestHelpers.AssertDriverContentsWithFrameAre (expected, output);

					Assert.True (btn3.ProcessKeyPressed (new (ConsoleDriverKey.Space)));
